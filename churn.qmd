...
```{r}
varImpPlot(rf_sensitive, main = "What makes customers leave?",pch= 16)
importance_scores <- as.data.frame(importance(rf_sensitive))
importance_scores[order(-importance_scores$MeanDecreaseAccuracy), ]
```
